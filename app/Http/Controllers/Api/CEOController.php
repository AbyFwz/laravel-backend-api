...
class CEOController extends Controller
{
    ...
    {
        $ceos = CEO::all();
        return response(['ceos' => CEOResource::collection($ceos), 'message' => 'Retreive Successfully'], 200);
    }
    ...
    {
        return response(['ceo' => new CEOResource($ceo), 'message' => 'Retreived Successfully'], 200);
    }
